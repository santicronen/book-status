...
public class Main {
    public static void main(String[] args) {
        Book b0 = new Book(); // object declarations
        Book b1 = new Book();
        Book b2 = new Book();

        b0.id = 0; // data per object
        b0.name = "The Bounty";
        b0.author = "Janey Evanovich";

        b1.id = 1;
        b1.name = "Deacon King Kong";
        b1.author = "James McBride";

        b2.id = 2;
        b2.name = "Hamnet";
        b2.author = "Maggie O'Farrel";
        
        // switch case depending on option
        switch (b0.input()) {
            case 0:
                // print book info
                System.out.println("ID: " + b0.id);
